...
The paper has now been proof read by a professional editor.
...
We have now coded participant sample information following your recommendation (age, gender distribution, ethnicity, and country) and have inserted a table summarizing this at the beginning of the results section.
...
As suggested we have added a title to demarcate the Limitations subsection. However, to demarcate this section from the subsequent one, we have also added a title to the last section called "Conclusion".  
