...
\quotetext{Analyses were performed in R programming language with the help of several additional libraries \citep{R2020,del2012a,datatable,ggplot2,metafor}.}
...
1. We have changed the title to ``The visual environment and attention in decision making'', this makes it more precise that we are concerned with visual environment and attention in the context of decision making. 
