...
We have now coded participant sample information following your recommendation (age, gender distribution, ethnicity, and country) and have placed a table summarizing this in the appendix. We have briefly given some context in the main text, given this information (line \lineref{sample-information}).

ADD INTERPRETATION AFTER TABLE IS FINALIZED
