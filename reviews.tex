...
Thank you for the feedback, in particular it is good to know that our writing strikes a right balance. Regarding effect sizes please note that they have changed in the revision. We updated the literature search and included 11 new articles. Some effect sizes did become larger (e.g. salience), but the most important point is that when taking into account publication bias we now see that visual factors play a larger role than cognitive factors. 
...
We agree that the name ``choice bias'' is potentially misleading and now refer to this factor as ``choice-gaze effect''. This name does not imply any direction of causality and hasn't been used previously to denote other effects. We do not use the term gaze cascade since it refers to the time window immediately before choice. It has also been termed "late onset bias", but we cannot conclude from this work whether the effect is early or late. Lastly, we have integrated a paragraph on the PCS model and the interesting attraction search effect in the discussion. We also suggest that the model and the implications of the attraction search effect may potentially provide the necessary background for explaining the choice-gaze effect (see line~\lineref{r426}).  
