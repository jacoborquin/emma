...
% Thu Mar 18 11:07:26 2021
\begin{table}[ht]
\centering
\caption{Participant sample characteristics grouped by visual and cognitive factors} 
\label{tab:sampleTable}
\begingroup\small
\begin{tabular}{lp{.05\linewidth}p{.05\linewidth}p{.05\linewidth}p{.05\linewidth}p{.05\linewidth}p{.05\linewidth}p{.05\linewidth}p{.05\linewidth}}
  \hline
