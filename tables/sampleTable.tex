...
% Thu Mar 18 11:08:47 2021
\begin{table}[ht]
\centering
\caption{Participant sample characteristics grouped by visual and cognitive factors} 
\label{tab:sampleTable}
\begingroup\small
\begin{tabular}{lp{.07\linewidth}p{.07\linewidth}p{.07\linewidth}p{.07\linewidth}p{.07\linewidth}p{.07\linewidth}p{.07\linewidth}p{.07\linewidth}}
  \hline
