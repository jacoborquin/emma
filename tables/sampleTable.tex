...
% Thu Mar 18 11:05:45 2021
\begin{table}[ht]
\centering
\caption{Participant sample characteristics grouped by visual and cognitive factors} 
\label{tab:sampleTable}
\begingroup\small
\begin{tabular}{lp{1\linewidth}p{1\linewidth}p{1\linewidth}p{1\linewidth}p{1\linewidth}p{1\linewidth}p{1\linewidth}p{1\linewidth}}
  \hline
