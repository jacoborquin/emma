...
% Thu Mar 18 11:11:47 2021
\begin{table}[ht]
\centering
\caption{Participant sample characteristics grouped by visual and cognitive factors} 
\label{tab:sampleTable}
\begingroup\small
\begin{tabular}{lp{.09\linewidth}p{.09\linewidth}p{.09\linewidth}p{.09\linewidth}p{.09\linewidth}p{.09\linewidth}p{.09\linewidth}p{.09\linewidth}}
  \hline
